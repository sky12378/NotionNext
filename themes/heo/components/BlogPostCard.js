        ...
        <div
          ...
          <header>
            ...
            <SmartLink
              ...
              passHref
              className={
                ' group-hover:text-[var(--heo-color-primary)] dark:hover:text-[var(--heo-color-accent)] dark:group-hover:text-[var(--heo-color-accent)] text-black dark:text-gray-100  line-clamp-2 replace cursor-pointer text-base font-extrabold leading-tight'
              }>
